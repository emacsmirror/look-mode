...
;; the user is prompted for a file glob.  In this case, the file list
;; is generated by a system call to "ls" which is probably is not
;; Windows compatible.  One moves through the file list using the
;; keybindings: C-. or M-n (`look-at-next-file') C-, or M-p
